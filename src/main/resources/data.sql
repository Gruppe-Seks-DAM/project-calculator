-- Keep project and subproject inserts the same
...
INSERT INTO task (id, subproject_id, name, description, deadline, estimated_hours) VALUES
 (1, 1, 'Fjernelse af gulv', 'Fjerne gammelt gulv og affald', DATE '2025-11-20', 8.0),
 (2, 1, 'Ny el-installation', 'Opgradere ledninger', DATE '2025-11-25', 12.5),
 (3, 2, 'Facadeafrensning', 'Rense og reparere facade', DATE '2025-12-05', 20.0);
